"""
Django settings for udesya project.
...
SECRET_KEY = 'django-insecure-q9iz4$aio_rht7#)8ed)&(_=$e*h=32-bk3j_p9e6cu@e(o66_'
...
WSGI_APPLICATION = 'udesya.wsgi.application'
...
AUTH_USER_MODEL = 'createpost.User'
